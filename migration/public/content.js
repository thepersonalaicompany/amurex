...
function showNotificationLive() {
  ...
  // Create Late to Meeting button
  let lateMeetingButton = document.createElement("button");
  lateMeetingButton.textContent = "Late to Meeting?";
  lateMeetingButton.style.cssText = `
    background: #c76dcc;
    color: white;
    border: none;
    padding: 5px 15px;
  ...
  lateMeetingButton.addEventListener("click", () => {
    chrome.runtime.sendMessage({
  ...
  buttonContainer.appendChild(lateMeetingButton);
...
document.addEventListener("DOMContentLoaded", function() {
  const icon = document.querySelector("#open-sidepanel-icon");
  if (icon) {
